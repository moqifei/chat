...
const (
	...
	Chat_GetADDepartmentList_FullMethodName     = "/openim.chat.chat/GetADDepartmentList"
	Chat_SearchADDepartments_FullMethodName     = "/openim.chat.chat/SearchADDepartments"
	Chat_GetADDepartmentMembers_FullMethodName  = "/openim.chat.chat/GetADDepartmentMembers"
	Chat_SearchADMembers_FullMethodName         = "/openim.chat.chat/SearchADMembers"
	Chat_SyncADOrganization_FullMethodName      = "/openim.chat.chat/SyncADOrganization"
)
...
type ChatClient interface {
	...
	// ────────── AD Organization ──────────
	// Query synced department list
	GetADDepartmentList(ctx context.Context, in *GetADDepartmentListReq, opts ...grpc.CallOption) (*GetADDepartmentListResp, error)
	// Search departments by keyword
	SearchADDepartments(ctx context.Context, in *SearchADDepartmentsReq, opts ...grpc.CallOption) (*SearchADDepartmentsResp, error)
	// Get members of a specific department
	GetADDepartmentMembers(ctx context.Context, in *GetADDepartmentMembersReq, opts ...grpc.CallOption) (*GetADDepartmentMembersResp, error)
	// Search organization members by name/nickname/username
	SearchADMembers(ctx context.Context, in *SearchADMembersReq, opts ...grpc.CallOption) (*SearchADMembersResp, error)
	// Trigger a manual AD organization sync
	SyncADOrganization(ctx context.Context, in *SyncADOrganizationReq, opts ...grpc.CallOption) (*SyncADOrganizationResp, error)
}
...
func (c *chatClient) GetADDepartmentList(ctx context.Context, in *GetADDepartmentListReq, opts ...grpc.CallOption) (*GetADDepartmentListResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetADDepartmentListResp)
	err := c.cc.Invoke(ctx, Chat_GetADDepartmentList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) SearchADDepartments(ctx context.Context, in *SearchADDepartmentsReq, opts ...grpc.CallOption) (*SearchADDepartmentsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchADDepartmentsResp)
	err := c.cc.Invoke(ctx, Chat_SearchADDepartments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) GetADDepartmentMembers(ctx context.Context, in *GetADDepartmentMembersReq, opts ...grpc.CallOption) (*GetADDepartmentMembersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetADDepartmentMembersResp)
	err := c.cc.Invoke(ctx, Chat_GetADDepartmentMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) SearchADMembers(ctx context.Context, in *SearchADMembersReq, opts ...grpc.CallOption) (*SearchADMembersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchADMembersResp)
	err := c.cc.Invoke(ctx, Chat_SearchADMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) SyncADOrganization(ctx context.Context, in *SyncADOrganizationReq, opts ...grpc.CallOption) (*SyncADOrganizationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncADOrganizationResp)
	err := c.cc.Invoke(ctx, Chat_SyncADOrganization_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServer interface {
	...
	// ────────── AD Organization ──────────
	// Query synced department list
	GetADDepartmentList(context.Context, *GetADDepartmentListReq) (*GetADDepartmentListResp, error)
	// Search departments by keyword
	SearchADDepartments(context.Context, *SearchADDepartmentsReq) (*SearchADDepartmentsResp, error)
	// Get members of a specific department
	GetADDepartmentMembers(context.Context, *GetADDepartmentMembersReq) (*GetADDepartmentMembersResp, error)
	// Search organization members by name/nickname/username
	SearchADMembers(context.Context, *SearchADMembersReq) (*SearchADMembersResp, error)
	// Trigger a manual AD organization sync
	SyncADOrganization(context.Context, *SyncADOrganizationReq) (*SyncADOrganizationResp, error)
...
func (UnimplementedChatServer) GetADDepartmentList(context.Context, *GetADDepartmentListReq) (*GetADDepartmentListResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetADDepartmentList not implemented")
}
func (UnimplementedChatServer) SearchADDepartments(context.Context, *SearchADDepartmentsReq) (*SearchADDepartmentsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchADDepartments not implemented")
}
func (UnimplementedChatServer) GetADDepartmentMembers(context.Context, *GetADDepartmentMembersReq) (*GetADDepartmentMembersResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetADDepartmentMembers not implemented")
}
func (UnimplementedChatServer) SearchADMembers(context.Context, *SearchADMembersReq) (*SearchADMembersResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchADMembers not implemented")
}
func (UnimplementedChatServer) SyncADOrganization(context.Context, *SyncADOrganizationReq) (*SyncADOrganizationResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncADOrganization not implemented")
}
...
func _Chat_GetADDepartmentList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetADDepartmentListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).GetADDepartmentList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_GetADDepartmentList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).GetADDepartmentList(ctx, req.(*GetADDepartmentListReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Chat_SearchADDepartments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchADDepartmentsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).SearchADDepartments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_SearchADDepartments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).SearchADDepartments(ctx, req.(*SearchADDepartmentsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Chat_GetADDepartmentMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetADDepartmentMembersReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).GetADDepartmentMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_GetADDepartmentMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).GetADDepartmentMembers(ctx, req.(*GetADDepartmentMembersReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Chat_SearchADMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchADMembersReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).SearchADMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_SearchADMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).SearchADMembers(ctx, req.(*SearchADMembersReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Chat_SyncADOrganization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncADOrganizationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).SyncADOrganization(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_SyncADOrganization_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).SyncADOrganization(ctx, req.(*SyncADOrganizationReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetADDepartmentList",
			Handler:    _Chat_GetADDepartmentList_Handler,
		},
		{
			MethodName: "SearchADDepartments",
			Handler:    _Chat_SearchADDepartments_Handler,
		},
		{
			MethodName: "GetADDepartmentMembers",
			Handler:    _Chat_GetADDepartmentMembers_Handler,
		},
		{
			MethodName: "SearchADMembers",
			Handler:    _Chat_SearchADMembers_Handler,
		},
		{
			MethodName: "SyncADOrganization",
			Handler:    _Chat_SyncADOrganization_Handler,
		},
	},
